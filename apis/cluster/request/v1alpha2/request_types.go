...
// completes; StartedAt tracks its lifetime; TerminalError and TerminalResponse carry
// a terminal failure (StartedAt and the Response anchor are retained across one).
